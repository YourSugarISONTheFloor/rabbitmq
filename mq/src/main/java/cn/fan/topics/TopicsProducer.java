...
public class TopicsProducer {
	public static void main(String[] args) throws IOException {
		...
		channel.exchangeDeclare(exchangeName, BuiltinExchangeType.TOPIC,false,true,false,null);
		//创建队列
		/**
		 ...
		 */
		//队列test_routing_queue1绑定 error
		channel.queueBind(queueName1,exchangeName,"order.*");
		//队列test_routing_queue2绑定 error info warning
		 ...
		 * 	4.body：真实的消息发送数据
		 */
		String routingKey="order.aa";
		String message="BuiltinExchangeType.TOPIC类型的交换机发布["+routingKey+"]路由key的信息";
