...
public class RoutingProducer {
	public static void main(String[] args) throws IOException {
		...
		channel.exchangeDeclare(exchangeName, BuiltinExchangeType.DIRECT,false,true,false,null);
		//创建队列
		/**
		 ...
		 * 	4.body：真实的消息发送数据
		 */
		String message="BuiltinExchangeType.DIRECT类型的交换机发布“error”路由key的信息";
